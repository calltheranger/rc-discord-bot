...
exports.executeDailySummary = exports.summarizeDailyHistory = exports.getDailyHistory = void 0;
const discord_js_1 = require("discord.js");
const generative_ai_1 = require("@google/generative-ai");
const getDailyHistory = async (client) => {
    const history = [];
...
const summarizeDailyHistory = async (history) => {
...
exports.summarizeDailyHistory = summarizeDailyHistory;
const executeDailySummary = async (client, overrideChannelId) => {
    try {
        ...
        const tc = targetChannel;
        const history = await (0, exports.getDailyHistory)(client);
        if (history.length === 0) {
            if (overrideChannelId)
                await tc.send("No activity recorded in the last 24 hours.");
            return;
        }
        const summaryMarkdown = await (0, exports.summarizeDailyHistory)(history);
        ...
        for (let i = 0; i < chunks.length; i++) {
            ...
            if (i === 0)
                embed.setTitle('📅 Daily Server Highlights');
